...
export default function UserProfile() {
  ...
  let menuItem=[
    ...
    {
      path:"userProfile/myAddressBook",
      name:" My address book",
      className:`d-flex mb-4 rounded-end rounded-5 ps-2 border nav-link  p-2 ${styles.link}`,
      icon: <i className="fa-solid fa-location-pin me-2"></i>,
      "data-bs-target":"#v-pills-myAddressBook",
      "aria-controls":"v-pills-myAddressBook" 
    },
    {
      path:"userProfile/myOrders",
      name:" My orders",
      className:`d-flex mb-4 rounded-end rounded-5 ps-2 border nav-link  p-2 ${styles.link}`,
      icon: <i className="fa-solid fa-bag-shopping me-2"></i>,
        ...
        <div className="row py-5">
            ...
            <div className="col-md-9 col-xxl-10 rounded shadow-lg">
              <div className="tab-content" id="v-pills-tabContent">
                ...
                <div className="tab-pane fade" id="v-pills-myAddressBook" role="tabpanel" aria-labelledby="v-pills-myAddressBook-tab" tabIndex="0">
                  <MyAddressBook/>
                </div>
                <div className="tab-pane fade" id="v-pills-myOrders" role="tabpanel" aria-labelledby="v-pills-myOrders-tab" tabIndex="0">
                  <MyOrders/>
                </div>
