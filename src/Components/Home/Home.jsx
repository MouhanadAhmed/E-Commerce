...
export default function Home() {
  return (
    ...
    <div className="container mb-5">
      <div className="row ">
        <div className="col-md-6 bg-light  rounded me-5 h-75  pt-5">
       ...
       <div className=" col-md-5 rounded bg-light h-50 pb-0 mb-5 px-0">
    ...
    <div className="bg-prim">
      <div className="container ">
        <div className="  py-5">
         <p className='mx-auto w-25 d-flex justify-content-center' > <span className="badge text-bg-light w-25 mx-auto text-center rounded-pill px-3 p-2 mb-5">New</span></p> 
